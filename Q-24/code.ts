...
var name1: string = "Usama";
var name2: string = "Khalid";
var name3: string = "Usama"
...
function numericalTests (input1:number, input2:number ) {
  if(input1 == input2) {
...
function logincalTest(marks:number) {
...
var marksArray:number[] = [59, 40, 90];
...
var itemToFind1: string = "banana";
var itemToFind2: string = "oringe"
findItem(itemToFind1);
findItem(itemToFind2);

function findItem(itemToFind:string) {
